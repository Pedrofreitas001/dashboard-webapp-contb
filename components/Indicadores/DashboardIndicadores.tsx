                ...
                <div className="max-w-[1400px] mx-auto">
                    <div className="flex flex-col items-center justify-center min-h-[60vh]">
                        ...
                        <div className={`rounded-xl border p-6 w-full max-w-2xl ${isDark ? 'bg-surface-dark border-border-dark' : 'bg-white border-gray-300'}`}>
                            ...
                            <div className={`rounded-lg p-4 mb-4 overflow-x-auto ${isDark ? 'bg-background-dark' : 'bg-gray-50'}`}>
                                <table className={`text-xs w-full ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                                    ...
                                    <tbody>
                                        ...
                                        <tr className={`border-b ${isDark ? 'border-border-dark/50' : 'border-gray-300/50'}`}>
                                            <td className={`py-2 font-mono ${isDark ? 'text-primary' : 'text-primary'}`}>roe</td>
                                            <td>número (%)</td>
                                            <td>15.3, 18.2...</td>
                                        </tr>
                                        <tr className={`border-b ${isDark ? 'border-border-dark/50' : 'border-gray-300/50'}`}>
                                            <td className={`py-2 font-mono ${isDark ? 'text-primary' : 'text-primary'}`}>roa</td>
                                            <td>número (%)</td>
                                            <td>8.2, 9.1...</td>
                                        </tr>
                                        <tr className={`border-b ${isDark ? 'border-border-dark/50' : 'border-gray-300/50'}`}>
                                            <td className={`py-2 font-mono ${isDark ? 'text-primary' : 'text-primary'}`}>margemLiquida</td>
                                            <td>número (%)</td>
                                            <td>12.5, 14.2...</td>
                                        </tr>
                                        <tr className={`border-b ${isDark ? 'border-border-dark/50' : 'border-gray-300/50'}`}>
                                            <td className={`py-2 font-mono ${isDark ? 'text-primary' : 'text-primary'}`}>liquidezCorrente</td>
                                            <td>número (x)</td>
                                            <td>1.8, 1.5...</td>
                                        </tr>
                                        <tr>
                                            <td className={`py-2 font-mono ${isDark ? 'text-primary' : 'text-primary'}`}>endividamento</td>
                                            <td>número (%)</td>
                                            <td>35.0, 40.5...</td>
                                        </tr>
                                    </tbody>
                            ...
                            <p className={`text-xs mb-4 ${isDark ? 'text-text-muted' : 'text-gray-600'}`}>Arquivo: <span className={`${isDark ? 'text-primary' : 'text-primary'} font-mono`}>Indicadores_Exemplo.xlsx</span></p>
